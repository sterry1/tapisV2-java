...
public class V2KeyManager
{
    ...
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = LoggerFactory.getLogger(V2KeyManager.class);
     ...
     */
    public V2KeyManager() throws KeyStoreException
    {
     ...
     */
    public V2KeyManager(String baseDir, String storeFilename) throws KeyStoreException
    {
        // Check input.
        ...
        try {_keyStore = KeyStore.getInstance(STORE_TYPE);}
                ...
                String msg = "ALOE_SECURITY_INSTANCE_FAILURE "+STORE_TYPE;
                _log.error(msg, e);
                throw e;
            }
    }
