...
public class RuntimeParameters {
  ...
  private boolean v2CompatibilityMode;
  
  
  // these need to move to shared library
  public static final String SERVICE_NAME_META  = "meta";
  public static final String V2_JWT_AUTH_HEADER_PREFIX = "X-JWT-Assertion";
  ...
  private RuntimeParameters() throws TapisRuntimeException {
    ...
    parm = inputProperties.getProperty("tapis.meta.service.v2.compatibility.mode");
    setV2CompatibilityMode(Boolean.valueOf(parm));
...
*/
  ...
  public boolean isV2CompatibilityMode() { return v2CompatibilityMode; }
  
  public void setV2CompatibilityMode(boolean v2CompatibilityMode) { this.v2CompatibilityMode = v2CompatibilityMode; }
